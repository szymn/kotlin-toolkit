...
dependencies {
    ...
    api("com.github.doublesymmetry.Exoplayer:exoplayer-core:r2.17.2")
    api("com.github.doublesymmetry.Exoplayer:exoplayer-ui:r2.17.2")
    api("com.github.doublesymmetry.Exoplayer:extension-mediasession:r2.17.2")
    api("com.github.doublesymmetry.Exoplayer:extension-media2:r2.17.2")
    api("com.github.doublesymmetry.Exoplayer:extension-workmanager:r2.17.2")
